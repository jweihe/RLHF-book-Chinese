...
*TAMER: Training an Agent Manually via Evaluative Reinforcement*（TAMER：通过评价型强化手动训练智能体）是利用人类对智能体行为的评价来训练反馈模型的早期代表性工作 [@knox2008tamer]。后来，COACH等方法提出了基于actor-critic结构的算法，将人类正负反馈用于调整优势函数 [@macglashan2017interactive]。
...
大量相关工作始于2019年的GPT-2与2020年的GPT-3之间。
