...
> **中文版修订说明（2026-09）：** 本版修正了已确认的概念、公式与代码问题，并更新排版。文中的时间性表述沿用原稿约 2025 年 4 月的语境，第一人称属于原作者。修订范围与依据见[勘误记录](https://github.com/jweihe/RLHF-book-Chinese/blob/main/docs/ERRATA.md)；本版尚未完成与英文出版版的逐句对照。
...
成对偏好损失用于奖励建模与 DPO 等方法；策略梯度则通过奖励或优势更新策略。不能把所有 RLHF 训练统一称为对比损失。
...
11. 策略梯度：RLHF中用于依据奖励模型（及其他信号）优化策略的核心强化学习技术
...
17. 过度优化：为何RLHF容易出错，以及奖励模型代理目标下的过度优化风险
...
RLHF 是后训练的重要工具之一。“后训练”涵盖的范围更广，还包括指令微调、蒸馏和可验证奖励训练等。
